...
hbsis.wms.settings.ItemStockByProductClassModel = Class.extend({
    init: function () {
...
hbsis.wms.settings.ItemStockByProductClassViewModel = hbsis.wms.CrudForm.extend({
    init: function (opts) {
        this._super(opts);
        ...
        this.initAutocompleteMultiple("#ProductClass", this.settings.productClassAutocompleteUrl, this.renderProductClass);
    ...
    createModel: function () {
        return ko.observable(new hbsis.wms.settings.ItemStockByProductClassModel());
    },
    ...
    productClassFind: function () {
        var self = this;
        self.ProductClass = hbsis.wms.Helpers.querystring('ProductClass');
        self.dirty(true);
    ...
    getDatatableConfig: function () {
        ...
        return {
            "fnServerParams": function (aoData) {
                aoData.push({ "name": "ProductClass", "value": $("#ProductClass").val() });
            },
            "aoColumns": [
              { "mData": "Armazem" },
              { "mData": "ClasseProduto" },
