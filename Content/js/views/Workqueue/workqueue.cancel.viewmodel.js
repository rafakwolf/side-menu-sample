...
hbsis.wms.settings.WorkQueueViewModel = hbsis.wms.CrudForm.extend({
    startDate: moment(),
    endDate: moment(),
    //deleteMarkup: "<a class=\"label label-danger delete\" href=\"#edit\" data-target=\"#save-modal\" ><i class=\"fa fa-times\"></i></a>",
    init: function (opts) {
        this._super(opts);
    ...
    getDatatableConfig: function () {
        ...
        return {
            ...
            "aoColumnDefs": [
                    ...
                    "bSearchable": true, "mRender": function (data, type, row) {
                        if (row.LicensePlate != null)
                            ...
                            if (row.PickMaster != null)
                                return row.PickMaster.LicensePlate;
                            else
                                return '-';
                    }
                },
                ...
                {
                    "aTargets": [5], "mData": null, "bSortable": true,
                    "bSearchable": false, "mRender": function (data, type, row) {
                        if (row.Status == 'Assigned') {
                            return resources.get(row.Status) + " <a class=\"label label-primary unassoc\" rel=\"" + row.Id + "\" rel-workType=\"" + row.WorkType + "\"><i class=\"fa fa-times\"></i></a>";
                ...
                },
                {
                    ...
                    "bSearchable": true, "mRender": function (data, type, row) {
                        if (row.Assignments[0] != null) {
                            return row.Assignments[0].User.Login;
                        } else {
                            return " - ";
                        }
                ...
                },
                {
                    "aTargets": [9],
                    "mData": null,
                    "sDefaultContent": self.deleteMarkup,
                    "bSortable": false,
                    "bSearchable": false,
                    "mRender": function (data, type, row) {
                        if (row.Status != "Canceled" && row.Status != "Completed")
                            return "<a class=\"label label-danger delete\" href=\"#edit\" data-target=\"#save-modal\" ><i class=\"fa fa-times\"></i></a>";
                        return "";
                    }
                }
            ]
