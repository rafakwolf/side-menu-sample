...
hbsis.wms.settings.ReceiptUnLoadWorkQueueModel = Class.extend({
	init: function () {
	}
});

hbsis.wms.settings.ReceiptUnLoadWorkQueueViewModel = hbsis.wms.CrudForm.extend({
    startDate: moment(),
    endDate: moment(),
	init: function (opts) {
	    this._super(opts);
	...
	createModel: function () {
		return ko.observable(new hbsis.wms.settings.ReceiptUnLoadWorkQueueModel());
	},
