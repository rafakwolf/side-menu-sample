...
hbsis.wms.settings.PickDetailModel = Class.extend({
    init: function () {
             
    }
});

hbsis.wms.settings.PickDetailViewModel = hbsis.wms.CrudForm.extend({
    startDate: moment(),
    endDate: moment(),
    init: function (opts) {
        this._super(opts);
    ...
    createModel: function () {
        return ko.observable(new hbsis.wms.settings.PickDetailModel());
    },
