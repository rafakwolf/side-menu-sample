...
hbsis.wms.settings.TempMapModel = Class.extend({
    init: function () {
        
    }
});

hbsis.wms.settings.TempMapViewModel = hbsis.wms.CrudForm.extend({
    startDate: moment(),
    endDate: moment(),
    init: function (opts) {
        this._super(opts);               
    ...
    createModel: function () {
        return ko.observable(new hbsis.wms.settings.TempMapModel());
    },
