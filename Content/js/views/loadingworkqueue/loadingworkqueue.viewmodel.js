...
hbsis.wms.settings.LoadingWorkQueueViewModel = hbsis.wms.CrudForm.extend({
    startDate: moment(),
    endDate: moment(),
    init: function (opts) {
        this._super(opts);
        ...
        return {
            ...
            "aoColumnDefs": [
                     ...
                     },
                {
                    ...
                    "bSearchable": false, "mRender": function (data, type, row) {
                        if(row.DataUltimaAssociacao)
                            return moment(row.DataUltimaAssociacao).format("DD/MM/YY HH:mm");
